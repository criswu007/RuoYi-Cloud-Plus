...
CREATE TABLE `staff` (
    `staff_id` int NOT NULL COMMENT 'ID',
    ...
    `site_id` bigint NULL,
    `dept_level_id` int NULL,
    `eff_date` datetime NULL,
    `exp_date` datetime NULL,
    `state` varchar(3) NOT NULL,
    `state_date` datetime NULL,
    `ip_limit` char(1) NULL,
    `ip_subnet` varchar(16) NULL,
    `ip_netmask` varchar(16) NULL,
    `ip_hostname` varchar(50) NULL,
    `pc_limit` int NULL,
    `pc_id` int NULL,
    `invoice_serial_nbr` int NULL,
    `last_date` datetime NULL,
    `email` varchar(80) NULL,
    `phone_no` varchar(24) NULL,
    `delete_state` char(1) NULL DEFAULT '0',
    `delete_time` datetime NULL,
    `remark` varchar(200) NULL,
    `staff_alias` varchar(40) NULL,
    `login_name` varchar(20) NULL,
    `pwd_mod_date` datetime NULL,
    `lan_id` varchar(10) NULL,
    `loginuid` varchar(80) NULL,
    `staff_code` varchar(30) NULL,
    `staff_state` decimal(20,0) NULL,
    `last_login_date` datetime NULL,
    `erro_times` decimal(20,0) NULL,
    `captcha` varchar(6) NULL,
    `validate_time` datetime NULL,
    `his_pwd` varchar(256) NULL,
    `safe_strategy` int NULL,
    `identity_id` varchar(18) NULL,
    `hr_code` varchar(25) NULL,
    ...
    `allow_batch_adjust_parent_addr` varchar(1) NULL,
    `region_id` varchar(24) NULL,
    `addr_batch_oper_permission` varchar(1) NULL,
    `opt_node_permission` varchar(1) NULL,
